...
local modelL1path = paths.concat('SpynetLossNetwork/models', 'modelL1_4.t7')
local modelL2path = paths.concat('SpynetLossNetwork/models', 'modelL2_4.t7')
local modelL3path = paths.concat('SpynetLossNetwork/models', 'modelL3_4.t7')
local modelL4path = paths.concat('SpynetLossNetwork/models', 'modelL4_4.t7')
local modelL5path = paths.concat('SpynetLossNetwork/models', 'modelL5_4.t7')
...
local model = nn.gModule({im5},{_flow5}):cuda()
